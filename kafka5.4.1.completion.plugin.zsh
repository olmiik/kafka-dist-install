...
_kafka_consumer_perf_test_args+=('--group: The group id to consume on. (default:  perf-consumer-31931) ')
...
declare -a _kafka_run_class_args
_kafka_run_class_args=()
compdef "_kafka-command kafka-run-class" kafka-run-class
...
declare -a _kafka_api_start_args
_kafka_api_start_args=()
compdef "_kafka-command kafka-api-start" kafka-api-start
